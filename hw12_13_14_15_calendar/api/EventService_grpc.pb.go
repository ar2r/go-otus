...
const (
	...
	EventService_ListOnDate_FullMethodName  = "/event.EventService/ListOnDate"
	EventService_ListOnWeek_FullMethodName  = "/event.EventService/ListOnWeek"
	EventService_ListOnMonth_FullMethodName = "/event.EventService/ListOnMonth"
)
